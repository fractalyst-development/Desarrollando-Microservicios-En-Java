...
This will create an executable jar file **fault_tolerance-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/fault_tolerance-microbundle.jar
